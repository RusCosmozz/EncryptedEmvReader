package ru.iu3.ecnryptedemvreader;
...
import ru.iu3.ecnryptedemvreader.object.PaycardObject;
...
public class ReadPaycardThread implements Runnable {
    private static final String TAG = ru.iu3.ecnryptedemvreader.thread.ReadPaycardThread.class.getSimpleName();
    ...
    public void run() {
                            ...
                            if (resultSize != -1) {
                                ...
                                if (byteArrayInputStream.read(resultRes, 0, resultSize) != 0) {
                                    if (Arrays.equals(resultRes, AidUtil.A0000000041010)) {
                                        ...
                                        LogUtil.d(TAG, mContext.getString(R.string.aid) + " Found: " + Arrays.toString(resultRes));
                                    } else if (Arrays.equals(resultRes, AidUtil.A0000006581010)) {
                                        isPayPass = true;
        ...
        } else if (Arrays.equals(aid, AidUtil.A0000006581010)) {
    ...
    private void performCommandPPSE(){
