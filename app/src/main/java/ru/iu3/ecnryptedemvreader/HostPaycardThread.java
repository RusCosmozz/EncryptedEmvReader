...
import ru.iu3.ecnryptedemvreader.activity.HostPaycardActivity;
...
public class HostPaycardThread implements Runnable {
    private static final String TAG = ru.iu3.ecnryptedemvreader.thread.HostPaycardThread.class.getSimpleName();
