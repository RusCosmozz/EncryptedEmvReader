package ru.iu3.ecnryptedemvreader.application;
...
public class MainApplication extends Application {
    private static final String TAG = ru.iu3.ecnryptedemvreader.application.MainApplication.class.getSimpleName();
