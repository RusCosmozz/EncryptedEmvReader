...
public class ReadPaycardConstsHelper {
    private static final String TAG = ReadPaycardConstsHelper.class.getSimpleName();
    ...
    public static final byte[] AIP_TLV_TAG = {
            (byte) 0x82
    }; // Aip
    ...
    public static final byte[] DEDICATED_FILE_NAME = {
            (byte) 0x84
    }; // DF

    public static final byte[] FCI_TEMPLATE = {
            (byte) 0xA5
    };
    ...
    public static final byte[] UNSIGN_APP_TAGS = {
            (byte) 0xBF,
            (byte) 0x62
    };
    ...
    public static final byte[] AUC_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x07
    }; // auc
    public static final byte[] APPLICATION_START_DATE_TLV_TAG = {
            (byte) 0x5F,
            (byte) 0x25
    };
    public static final byte[] APPLICATION_INFO_TLV_TAG = {
            (byte) 0xDF,
            (byte) 0x70
    };
    ...
    public static final byte[] LVP_SUPPORT_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x7A
    }; // Low value payments
    ...
    public static final byte[] TERMINAL_TYPE_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x35
    }; // terminal type

    public static final byte[] ADDITIONAL_TERMINAL_CAPABILITIES_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x40
    }; // terminal type
